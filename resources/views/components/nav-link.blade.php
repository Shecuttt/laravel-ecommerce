...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-primary text-sm font-semibold leading-5 text-foreground focus:outline-none focus:border-primary transition duration-150 ease-in-out'
