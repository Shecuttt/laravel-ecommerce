<x-guest-layout>
    <!-- Header -->
    <div class="mb-8">
        <h2 class="text-2xl font-bold text-foreground tracking-tight">Daftar Akun Baru</h2>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <!-- Name -->
        <div>
            <x-input-label for="name" :value="__('Nama')" class="font-semibold text-foreground" />
        ...
        <!-- Confirm Password -->
        <div>
            <x-input-label for="password_confirmation" :value="__('Konfirmasi Kata Sandi')" class="font-semibold text-foreground" />
